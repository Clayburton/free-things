...
const ITEMS = [

  {
    ...
    specs: ['Kontakt 6+', '59.8 MB installed'],
    features: [
...

  {
    ...
    specs: ['Kontakt 6+', '127.1 MB installed'],
    features: [
...

  {
    ...
    specs: ['Kontakt 6+', '126.1 MB installed'],
    features: [
...

  {
    ...
    specs: ['Kontakt 6+', '331.2 MB installed'],
    features: [
      'One-string Diddley bow direct into a BAE 1073 MPF',
      'Through the Shallow Waters pedal by Fairfield Circuitry',
...

  {
    ...
    specs: ['Kontakt 7+', '520.4 MB installed'],
    features: [
  ...
  /* When there are enough plugin trials to be worth grouping, uncomment this
     and they get their own heading on the table:            */
  // { divider: 'plugins' },
